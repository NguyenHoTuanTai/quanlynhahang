    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trang_thai', models.CharField(blank=True, max_length=50, null=True, verbose_name='Trạng thái')),
                ('thoi_gian_tao', models.DateTimeField(blank=True, null=True)),
                ('ban', models.ForeignKey(blank=True, db_column='ban_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.ban', verbose_name='Bàn được xếp')),
            ],
            options={
